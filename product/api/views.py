...
from product.api.serializers import ProductCategorySerializer, ProductSerializer, ProductCreateSerializer, SubscribeSerializer, ProductTagSerializer
...
class ProudctTagListAPIView(ListAPIView):
